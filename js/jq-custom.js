	...
	function start(){
		...
		setTimeout(function(){
		myTimer = setInterval(function(){myTimer1()},1500);
		});
	}
	...
	function checkIfLogin(){
		if(localStorageUsername == "" || localStorageUsername == null){
			...
			$("#btn-login").html('<img src="img/Logout.png">');
			$("#btn-register").hide();
		}
	...
	function logout(){
		if(localStorageUsername == "" || localStorageUsername == null){
			...
			$("#txt-username").text("");
			$("#btn-login").html('<img src="img/Login.png">');
	...
	function postScoreOnline(){		
		...
		if(a == null || a == ""){
			$("#game_over_page_msg").html("<h4>You need to <a class='btn-login' href='#stack2' data-toggle='modal'>login</a></h4>");
